...
ActiveRecord::Schema.define(version: 2019_11_05_174518) do
  ...
  create_table "implementation_stages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["initiative_id"], name: "index_implementation_stages_on_initiative_id"
  end
  ...
  create_table "stop_initiative_requests", force: :cascade do |t|
    t.integer "idea_id"
    t.boolean "resolved"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["idea_id"], name: "index_stop_initiative_requests_on_idea_id"
  end
